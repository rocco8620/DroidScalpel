...
.field protected final eventStorage:Lio/fabric/sdk/android/services/c/g;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lio/fabric/sdk/android/services/c/c;Lio/fabric/sdk/android/services/b/k;Lio/fabric/sdk/android/services/c/g;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/fabric/sdk/android/services/c/d;->context:Landroid/content/Context;

    .line 76
    iput-object p2, p0, Lio/fabric/sdk/android/services/c/d;->transform:Lio/fabric/sdk/android/services/c/c;

    .line 77
    iput-object p4, p0, Lio/fabric/sdk/android/services/c/d;->eventStorage:Lio/fabric/sdk/android/services/c/g;

    .line 78
    iput-object p3, p0, Lio/fabric/sdk/android/services/c/d;->currentTimeProvider:Lio/fabric/sdk/android/services/b/k;

    .line 80
    iget-object p1, p0, Lio/fabric/sdk/android/services/c/d;->currentTimeProvider:Lio/fabric/sdk/android/services/b/k;

    invoke-interface {p1}, Lio/fabric/sdk/android/services/b/k;->a()J

    move-result-wide p1

    iput-wide p1, p0, Lio/fabric/sdk/android/services/c/d;->lastRollOverTime:J

    .line 82
    iput p5, p0, Lio/fabric/sdk/android/services/c/d;->defaultMaxFilesToKeep:I
...
.method private rollFileOverIfNeeded(I)V
    ...
    .line 137
    iget-object v0, p0, Lio/fabric/sdk/android/services/c/d;->eventStorage:Lio/fabric/sdk/android/services/c/g;

    invoke-virtual {p0}, Lio/fabric/sdk/android/services/c/d;->getMaxByteSizePerFile()I

    move-result v1

    invoke-interface {v0, p1, v1}, Lio/fabric/sdk/android/services/c/g;->a(II)Z
    ...
    iget-object v4, p0, Lio/fabric/sdk/android/services/c/d;->eventStorage:Lio/fabric/sdk/android/services/c/g;

    .line 142
    invoke-interface {v4}, Lio/fabric/sdk/android/services/c/g;->a()I
...
.method private triggerRollOverOnListeners(Ljava/lang/String;)V
    ...
    check-cast v1, Lio/fabric/sdk/android/services/c/h;

    .line 170
    :try_start_0
    invoke-interface {v1, p1}, Lio/fabric/sdk/android/services/c/h;->onRollOver(Ljava/lang/String;)V
    :try_end_0
...
.method public deleteAllEventsFiles()V
    ...
    iget-object v1, p0, Lio/fabric/sdk/android/services/c/d;->eventStorage:Lio/fabric/sdk/android/services/c/g;

    .line 188
    invoke-interface {v1}, Lio/fabric/sdk/android/services/c/g;->c()Ljava/util/List;

    move-result-object v1

    .line 187
    invoke-interface {v0, v1}, Lio/fabric/sdk/android/services/c/g;->a(Ljava/util/List;)V

    .line 189
    iget-object v0, p0, Lio/fabric/sdk/android/services/c/d;->eventStorage:Lio/fabric/sdk/android/services/c/g;

    invoke-interface {v0}, Lio/fabric/sdk/android/services/c/g;->d()V
...
.method public deleteOldestInRollOverIfOverMax()V
    ...
    invoke-interface {v0}, Lio/fabric/sdk/android/services/c/g;->c()Ljava/util/List;

    move-result-object v0

    .line 194
    invoke-virtual {p0}, Lio/fabric/sdk/android/services/c/d;->getMaxFilesToKeep()I
    ...
    new-instance v3, Lio/fabric/sdk/android/services/c/d$1;

    invoke-direct {v3, p0}, Lio/fabric/sdk/android/services/c/d$1;-><init>(Lio/fabric/sdk/android/services/c/d;)V
    ...
    .line 217
    new-instance v6, Lio/fabric/sdk/android/services/c/d$a;

    invoke-direct {v6, v3, v4, v5}, Lio/fabric/sdk/android/services/c/d$a;-><init>(Ljava/io/File;J)V
    ...
    check-cast v3, Lio/fabric/sdk/android/services/c/d$a;

    .line 222
    iget-object v3, v3, Lio/fabric/sdk/android/services/c/d$a;->a:Ljava/io/File;
    ...
    invoke-interface {v1, v0}, Lio/fabric/sdk/android/services/c/g;->a(Ljava/util/List;)V
...
.method public deleteSentFiles(Ljava/util/List;)V
    ...
    invoke-interface {v0, p1}, Lio/fabric/sdk/android/services/c/g;->a(Ljava/util/List;)V
...
.method public getBatchOfFilesToSend()Ljava/util/List;
    ...
    invoke-interface {v0, v1}, Lio/fabric/sdk/android/services/c/g;->a(I)Ljava/util/List;
...
.method protected getMaxFilesToKeep()I
    ...
    .line 156
    iget v0, p0, Lio/fabric/sdk/android/services/c/d;->defaultMaxFilesToKeep:I
...
.method public registerRollOverListener(Lio/fabric/sdk/android/services/c/h;)V
    .locals 1
...
.method public rollFileOver()Z
    ...
    invoke-interface {v0}, Lio/fabric/sdk/android/services/c/g;->b()Z
    ...
    .line 114
    iget-object v3, p0, Lio/fabric/sdk/android/services/c/d;->eventStorage:Lio/fabric/sdk/android/services/c/g;

    invoke-interface {v3, v0}, Lio/fabric/sdk/android/services/c/g;->a(Ljava/lang/String;)V
    ...
    .line 122
    iget-object v2, p0, Lio/fabric/sdk/android/services/c/d;->currentTimeProvider:Lio/fabric/sdk/android/services/b/k;
...
.method public writeEvent(Ljava/lang/Object;)V
    ...
    invoke-direct {p0, v0}, Lio/fabric/sdk/android/services/c/d;->rollFileOverIfNeeded(I)V

    .line 89
    iget-object v0, p0, Lio/fabric/sdk/android/services/c/d;->eventStorage:Lio/fabric/sdk/android/services/c/g;

    invoke-interface {v0, p1}, Lio/fabric/sdk/android/services/c/g;->a([B)V
