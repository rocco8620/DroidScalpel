...
.field final mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;
...
.field final mVerticalAxis:Landroid/support/v7/widget/GridLayout$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 255
    new-instance p3, Landroid/support/v7/widget/GridLayout$c;

    const/4 v0, 0x1

    invoke-direct {p3, p0, v0}, Landroid/support/v7/widget/GridLayout$c;-><init>(Landroid/support/v7/widget/GridLayout;Z)V

    iput-object p3, p0, Landroid/support/v7/widget/GridLayout;->mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;
    ...
    invoke-direct {p3, p0, v1}, Landroid/support/v7/widget/GridLayout$c;-><init>(Landroid/support/v7/widget/GridLayout;Z)V

    iput-object p3, p0, Landroid/support/v7/widget/GridLayout;->mVerticalAxis:Landroid/support/v7/widget/GridLayout$c;
...
.method private checkLayoutParams(Landroid/support/v7/widget/GridLayout$LayoutParams;Z)V
    ...
    .line 816
    iget v1, p1, Landroid/support/v7/widget/GridLayout$e;->a:I
    ...
    .line 819
    iget-object p2, p0, Landroid/support/v7/widget/GridLayout;->mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;

    goto :goto_2

    :cond_3
    iget-object p2, p0, Landroid/support/v7/widget/GridLayout;->mVerticalAxis:Landroid/support/v7/widget/GridLayout$c;

    .line 820
    :goto_2
    iget p2, p2, Landroid/support/v7/widget/GridLayout$c;->b:I

    if-eq p2, v2, :cond_5

    .line 822
    iget v1, p1, Landroid/support/v7/widget/GridLayout$e;->b:I
    ...
    .line 826
    :cond_4
    invoke-virtual {p1}, Landroid/support/v7/widget/GridLayout$e;->a()I
...
.method private static clip(Landroid/support/v7/widget/GridLayout$e;ZI)I
    .locals 1
    ...
    .line 725
    iget p0, p0, Landroid/support/v7/widget/GridLayout$e;->a:I
...
.method private getDefaultMargin(Landroid/view/View;Landroid/support/v7/widget/GridLayout$LayoutParams;ZZ)I
    ...
    .line 660
    iget-object v0, p0, Landroid/support/v7/widget/GridLayout;->mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;

    goto :goto_1

    :cond_2
    iget-object v0, p0, Landroid/support/v7/widget/GridLayout;->mVerticalAxis:Landroid/support/v7/widget/GridLayout$c;

    .line 661
    :goto_1
    iget-object p2, p2, Landroid/support/v7/widget/GridLayout$Spec;->span:Landroid/support/v7/widget/GridLayout$e;
    ...
    .line 663
    iget p2, p2, Landroid/support/v7/widget/GridLayout$e;->a:I
    ...
    :cond_5
    iget p2, p2, Landroid/support/v7/widget/GridLayout$e;->b:I
...
.method private getMargin(Landroid/view/View;ZZ)I
    ...
    .line 685
    invoke-virtual {v0}, Landroid/support/v7/widget/GridLayout$c;->e()[I
    ...
    :cond_2
    invoke-virtual {v0}, Landroid/support/v7/widget/GridLayout$c;->f()[I
    ...
    iget p1, p1, Landroid/support/v7/widget/GridLayout$e;->b:I
...
.method private invalidateStructure()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/GridLayout$c;->i()V
...
.method private invalidateValues()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/GridLayout$c;->j()V
...
.method private measureChildrenWithMargins(IIZ)V
    ...
    .line 924
    iget-object v6, v6, Landroid/support/v7/widget/GridLayout$Spec;->span:Landroid/support/v7/widget/GridLayout$e;

    if-eqz v5, :cond_4

    .line 925
    iget-object v7, p0, Landroid/support/v7/widget/GridLayout;->mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;

    goto :goto_3

    :cond_4
    iget-object v7, p0, Landroid/support/v7/widget/GridLayout;->mVerticalAxis:Landroid/support/v7/widget/GridLayout$c;

    .line 926
    :goto_3
    invoke-virtual {v7}, Landroid/support/v7/widget/GridLayout$c;->h()[I

    move-result-object v7

    .line 927
    iget v8, v6, Landroid/support/v7/widget/GridLayout$e;->b:I

    aget v8, v7, v8

    iget v6, v6, Landroid/support/v7/widget/GridLayout$e;->a:I
...
.method private static setCellGroup(Landroid/support/v7/widget/GridLayout$LayoutParams;IIII)V
    ...
    invoke-direct {v0, p1, p2}, Landroid/support/v7/widget/GridLayout$e;-><init>(II)V

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/GridLayout$LayoutParams;->setRowSpecSpan(Landroid/support/v7/widget/GridLayout$e;)V

    .line 716
    new-instance p1, Landroid/support/v7/widget/GridLayout$e;

    add-int/2addr p4, p3

    invoke-direct {p1, p3, p4}, Landroid/support/v7/widget/GridLayout$e;-><init>(II)V

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/GridLayout$LayoutParams;->setColumnSpecSpan(Landroid/support/v7/widget/GridLayout$e;)V
...
.method private validateLayoutParams()V
    ...
    .line 732
    iget-object v2, p0, Landroid/support/v7/widget/GridLayout;->mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;

    goto :goto_1

    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/GridLayout;->mVerticalAxis:Landroid/support/v7/widget/GridLayout$c;

    .line 733
    :goto_1
    iget v3, v2, Landroid/support/v7/widget/GridLayout$c;->b:I

    const/high16 v4, -0x80000000

    if-eq v3, v4, :cond_2

    iget v2, v2, Landroid/support/v7/widget/GridLayout$c;->b:I
    ...
    .line 743
    :goto_4
    iget-object v10, v9, Landroid/support/v7/widget/GridLayout$Spec;->span:Landroid/support/v7/widget/GridLayout$e;
    ...
    .line 747
    iget v7, v10, Landroid/support/v7/widget/GridLayout$e;->a:I
    ...
    .line 751
    :goto_5
    iget-object v12, v10, Landroid/support/v7/widget/GridLayout$Spec;->span:Landroid/support/v7/widget/GridLayout$e;

    .line 752
    iget-boolean v10, v10, Landroid/support/v7/widget/GridLayout$Spec;->startDefined:Z

    .line 753
    invoke-static {v12, v10, v2}, Landroid/support/v7/widget/GridLayout;->clip(Landroid/support/v7/widget/GridLayout$e;ZI)I
    ...
    .line 755
    iget v6, v12, Landroid/support/v7/widget/GridLayout$e;->a:I
...
.method public isColumnOrderPreserved()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/GridLayout$c;->b()Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 1025
    iget-object v2, v6, Landroid/support/v7/widget/GridLayout;->mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;

    sub-int v3, v7, v8

    sub-int/2addr v3, v10

    invoke-virtual {v2, v3}, Landroid/support/v7/widget/GridLayout$c;->c(I)V

    .line 1026
    iget-object v2, v6, Landroid/support/v7/widget/GridLayout;->mVerticalAxis:Landroid/support/v7/widget/GridLayout$c;

    sub-int/2addr v0, v9

    sub-int/2addr v0, v1

    invoke-virtual {v2, v0}, Landroid/support/v7/widget/GridLayout$c;->c(I)V

    .line 1028
    iget-object v0, v6, Landroid/support/v7/widget/GridLayout;->mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;

    invoke-virtual {v0}, Landroid/support/v7/widget/GridLayout$c;->h()[I

    move-result-object v11

    .line 1029
    iget-object v0, v6, Landroid/support/v7/widget/GridLayout;->mVerticalAxis:Landroid/support/v7/widget/GridLayout$c;
    ...
    .line 1038
    iget-object v2, v1, Landroid/support/v7/widget/GridLayout$Spec;->span:Landroid/support/v7/widget/GridLayout$e;

    .line 1039
    iget-object v3, v0, Landroid/support/v7/widget/GridLayout$Spec;->span:Landroid/support/v7/widget/GridLayout$e;

    .line 1041
    iget v4, v2, Landroid/support/v7/widget/GridLayout$e;->a:I

    aget v16, v11, v4

    .line 1042
    iget v4, v3, Landroid/support/v7/widget/GridLayout$e;->a:I

    aget v17, v12, v4

    .line 1044
    iget v2, v2, Landroid/support/v7/widget/GridLayout$e;->b:I

    aget v2, v11, v2

    .line 1045
    iget v3, v3, Landroid/support/v7/widget/GridLayout$e;->b:I
    ...
    .line 1056
    iget-object v14, v6, Landroid/support/v7/widget/GridLayout;->mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;

    invoke-virtual {v14}, Landroid/support/v7/widget/GridLayout$c;->c()Landroid/support/v7/widget/GridLayout$g;

    move-result-object v14

    invoke-virtual {v14, v15}, Landroid/support/v7/widget/GridLayout$g;->a(I)Ljava/lang/Object;

    move-result-object v14

    check-cast v14, Landroid/support/v7/widget/GridLayout$d;

    .line 1057
    iget-object v2, v6, Landroid/support/v7/widget/GridLayout;->mVerticalAxis:Landroid/support/v7/widget/GridLayout$c;

    invoke-virtual {v2}, Landroid/support/v7/widget/GridLayout$c;->c()Landroid/support/v7/widget/GridLayout$g;

    move-result-object v2

    invoke-virtual {v2, v15}, Landroid/support/v7/widget/GridLayout$g;->a(I)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/support/v7/widget/GridLayout$d;
    ...
    .line 1060
    invoke-virtual {v14, v3}, Landroid/support/v7/widget/GridLayout$d;->a(Z)I
    ...
    .line 1061
    invoke-virtual {v2, v3}, Landroid/support/v7/widget/GridLayout$d;->a(Z)I
    ...
    .line 1072
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/GridLayout$d;->a(Landroid/support/v7/widget/GridLayout;Landroid/view/View;Landroid/support/v7/widget/GridLayout$Alignment;IZ)I
...
.method protected onMeasure(II)V
    ...
    .line 965
    iget-object v4, p0, Landroid/support/v7/widget/GridLayout;->mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;

    invoke-virtual {v4, v2}, Landroid/support/v7/widget/GridLayout$c;->b(I)I
    ...
    invoke-virtual {v2, v3}, Landroid/support/v7/widget/GridLayout$c;->b(I)I
    ...
    .line 969
    :cond_0
    iget-object v4, p0, Landroid/support/v7/widget/GridLayout;->mVerticalAxis:Landroid/support/v7/widget/GridLayout$c;

    invoke-virtual {v4, v3}, Landroid/support/v7/widget/GridLayout$c;->b(I)I
    ...
    .line 971
    iget-object v3, p0, Landroid/support/v7/widget/GridLayout;->mHorizontalAxis:Landroid/support/v7/widget/GridLayout$c;

    invoke-virtual {v3, v2}, Landroid/support/v7/widget/GridLayout$c;->b(I)I
