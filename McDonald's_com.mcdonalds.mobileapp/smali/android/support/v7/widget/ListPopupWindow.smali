...
.field mDropDownList:Landroid/support/v7/widget/s;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->mResizePopupRunnable:Landroid/support/v7/widget/ListPopupWindow$e;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->mTouchInterceptor:Landroid/support/v7/widget/ListPopupWindow$d;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->mScrollListener:Landroid/support/v7/widget/ListPopupWindow$c;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->mHideSelector:Landroid/support/v7/widget/ListPopupWindow$a;
...
.method private buildDropDown()I
    ...
    .line 1137
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;
    ...
    invoke-virtual {p0, v0, v5}, Landroid/support/v7/widget/ListPopupWindow;->createDropDownListView(Landroid/content/Context;Z)Landroid/support/v7/widget/s;

    move-result-object v5

    iput-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;
    ...
    .line 1159
    iget-object v5, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;
    ...
    .line 1300
    :goto_7
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;
    ...
    invoke-virtual/range {v6 .. v11}, Landroid/support/v7/widget/s;->measureHeightOfChildrenCompat(IIIII)I
    ...
    .line 1303
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;

    invoke-virtual {v2}, Landroid/support/v7/widget/s;->getPaddingTop()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;
...
.method createDropDownListView(Landroid/content/Context;Z)Landroid/support/v7/widget/s;
    .locals 1
...
.method public dismiss()V
    ...
    .line 754
    iput-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;
...
.method public getSelectedItem()Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/s;->getSelectedItem()Ljava/lang/Object;
...
.method public getSelectedItemId()J
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/s;->getSelectedItemId()J
...
.method public getSelectedItemPosition()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/s;->getSelectedItemPosition()I
...
.method public getSelectedView()Landroid/view/View;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/s;->getSelectedView()Landroid/view/View;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 978
    invoke-virtual {v6, v1, v3}, Landroid/support/v7/widget/s;->lookForSelectablePosition(IZ)I
    ...
    invoke-virtual {v5, v4, v1}, Landroid/support/v7/widget/s;->lookForSelectablePosition(IZ)I
    ...
    .line 994
    :cond_6
    iget-object v8, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;

    invoke-virtual {v8, v1}, Landroid/support/v7/widget/s;->setListSelectionHidden(Z)V

    .line 997
    iget-object v8, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;

    invoke-virtual {v8, p1, p2}, Landroid/support/v7/widget/s;->onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 1008
    iget-object p2, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;

    invoke-virtual {p2}, Landroid/support/v7/widget/s;->requestFocusFromTouch()Z
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/s;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public performItemClick(I)Z
    ...
    .line 861
    invoke-virtual {v2}, Landroid/support/v7/widget/s;->getFirstVisiblePosition()I
    ...
    .line 862
    invoke-virtual {v2}, Landroid/support/v7/widget/s;->getAdapter()Landroid/widget/ListAdapter;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 290
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/s;
