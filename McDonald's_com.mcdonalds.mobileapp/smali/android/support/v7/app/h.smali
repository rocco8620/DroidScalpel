...
.method static constructor <clinit>()V
    ...
    .line 80
    sput-boolean v2, Landroid/support/v7/app/h;->m:Z
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/f;)V
    ...
    .line 117
    iget-object p2, p0, Landroid/support/v7/app/h;->b:Landroid/view/Window;

    invoke-virtual {p2}, Landroid/view/Window;->getCallback()Landroid/view/Window$Callback;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/app/h;->c:Landroid/view/Window$Callback;

    .line 118
    iget-object p2, p0, Landroid/support/v7/app/h;->c:Landroid/view/Window$Callback;

    instance-of p2, p2, Landroid/support/v7/app/h$b;
    ...
    invoke-virtual {p0, p2}, Landroid/support/v7/app/h;->a(Landroid/view/Window$Callback;)Landroid/view/Window$Callback;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/app/h;->d:Landroid/view/Window$Callback;

    .line 124
    iget-object p2, p0, Landroid/support/v7/app/h;->b:Landroid/view/Window;

    iget-object p3, p0, Landroid/support/v7/app/h;->d:Landroid/view/Window$Callback;
    ...
    .line 126
    sget-object p3, Landroid/support/v7/app/h;->o:[I
    ...
    .line 130
    iget-object p3, p0, Landroid/support/v7/app/h;->b:Landroid/view/Window;
...
.method public b()Landroid/view/MenuInflater;
    ...
    iget-object v1, p0, Landroid/support/v7/app/h;->f:Landroid/support/v7/app/a;
    ...
    iput-object v0, p0, Landroid/support/v7/app/h;->g:Landroid/view/MenuInflater;
