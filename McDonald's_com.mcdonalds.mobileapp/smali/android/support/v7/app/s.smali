...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    .line 123
    iput-boolean v0, p0, Landroid/support/v7/app/s;->k:Z
    ...
    iput-object v0, p0, Landroid/support/v7/app/s;->p:Landroid/support/v4/view/y;
    ...
    iput-object v0, p0, Landroid/support/v7/app/s;->q:Landroid/support/v4/view/y;
    ...
    iput-object v0, p0, Landroid/support/v7/app/s;->r:Landroid/support/v4/view/aa;
    ...
    .line 172
    invoke-direct {p0, p1}, Landroid/support/v7/app/s;->a(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroid/support/v7/app/s;->f:Landroid/view/View;
...
.method private a(Landroid/view/View;)V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/app/s;->b(Landroid/view/View;)Landroid/support/v7/widget/DecorToolbar;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/app/s;->d:Landroid/support/v7/widget/DecorToolbar;
    ...
    iput-object p1, p0, Landroid/support/v7/app/s;->c:Landroid/support/v7/widget/ActionBarContainer;

    .line 204
    iget-object p1, p0, Landroid/support/v7/app/s;->d:Landroid/support/v7/widget/DecorToolbar;

    if-eqz p1, :cond_8

    iget-object p1, p0, Landroid/support/v7/app/s;->e:Landroid/support/v7/widget/ActionBarContextView;

    if-eqz p1, :cond_8

    iget-object p1, p0, Landroid/support/v7/app/s;->c:Landroid/support/v7/widget/ActionBarContainer;
    ...
    .line 215
    iput-boolean v0, p0, Landroid/support/v7/app/s;->A:Z
    ...
    :goto_2
    invoke-virtual {p0, p1}, Landroid/support/v7/app/s;->b(Z)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/app/s;->j(Z)V

    .line 222
    iget-object p1, p0, Landroid/support/v7/app/s;->a:Landroid/content/Context;
    ...
    .line 226
    invoke-virtual {p0, v0}, Landroid/support/v7/app/s;->c(Z)V
    ...
    .line 230
    invoke-virtual {p0, v0}, Landroid/support/v7/app/s;->a(F)V
...
.method private j(Z)V
    ...
    .line 264
    iget-boolean p1, p0, Landroid/support/v7/app/s;->D:Z
    ...
    iget-object v0, p0, Landroid/support/v7/app/s;->g:Landroid/support/v7/widget/ScrollingTabContainerView;
    ...
    invoke-static {v0}, Landroid/support/v4/view/t;->p(Landroid/view/View;)V
    ...
    :cond_3
    :goto_2
    iget-object v0, p0, Landroid/support/v7/app/s;->d:Landroid/support/v7/widget/DecorToolbar;
...
.method private k(Z)V
    ...
    .line 776
    invoke-virtual {p0, p1}, Landroid/support/v7/app/s;->g(Z)V
...
.method public a(II)V
    ...
    .line 477
    :cond_0
    iget-object v1, p0, Landroid/support/v7/app/s;->d:Landroid/support/v7/widget/DecorToolbar;
...
.method public a(Z)V
    ...
    .line 379
    :goto_0
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/app/s;->a(II)V
...
.method public e(Z)V
    ...
    .line 333
    iget-object p1, p0, Landroid/support/v7/app/s;->n:Landroid/support/v7/view/h;
...
.method public f(Z)V
    ...
    .line 357
    iget-object v2, p0, Landroid/support/v7/app/s;->C:Ljava/util/ArrayList;
...
.method public g(Z)V
    ...
    .line 804
    iget-object v3, p0, Landroid/support/v7/app/s;->r:Landroid/support/v4/view/aa;
    ...
    .line 819
    iget-object v0, p0, Landroid/support/v7/app/s;->q:Landroid/support/v4/view/y;

    invoke-virtual {p1, v0}, Landroid/support/v7/view/h;->a(Landroid/support/v4/view/y;)Landroid/support/v7/view/h;

    .line 820
    iput-object p1, p0, Landroid/support/v7/app/s;->n:Landroid/support/v7/view/h;
    ...
    .line 825
    iget-boolean p1, p0, Landroid/support/v7/app/s;->k:Z

    if-eqz p1, :cond_5

    iget-object p1, p0, Landroid/support/v7/app/s;->f:Landroid/view/View;
    ...
    .line 828
    :cond_5
    iget-object p1, p0, Landroid/support/v7/app/s;->q:Landroid/support/v4/view/y;
    ...
    .line 830
    :goto_0
    iget-object p1, p0, Landroid/support/v7/app/s;->b:Landroid/support/v7/widget/ActionBarOverlayLayout;
...
.method public h(Z)V
    ...
    .line 851
    iget-object v1, p0, Landroid/support/v7/app/s;->r:Landroid/support/v4/view/aa;
    ...
    .line 856
    :cond_3
    sget-object p1, Landroid/support/v7/app/s;->t:Landroid/view/animation/Interpolator;
    ...
    .line 858
    iget-object p1, p0, Landroid/support/v7/app/s;->p:Landroid/support/v4/view/y;
...
.method public i(Z)V
    ...
    .line 875
    invoke-direct {p0}, Landroid/support/v7/app/s;->l()V

    goto :goto_0

    .line 877
    :cond_0
    invoke-direct {p0}, Landroid/support/v7/app/s;->m()V

    .line 880
    :goto_0
    invoke-direct {p0}, Landroid/support/v7/app/s;->n()Z
    ...
    invoke-interface {p1, v2, v6, v7}, Landroid/support/v7/widget/DecorToolbar;->setupAnimatorToVisibility(IJ)Landroid/support/v4/view/x;
    ...
    invoke-interface {p1, v3, v4, v5}, Landroid/support/v7/widget/DecorToolbar;->setupAnimatorToVisibility(IJ)Landroid/support/v4/view/x;
    ...
    invoke-virtual {p1, v1, v6, v7}, Landroid/support/v7/widget/ActionBarContextView;->setupAnimatorToVisibility(IJ)Landroid/support/v4/view/x;
...
.method j()V
    ...
    .line 313
    iput-object v0, p0, Landroid/support/v7/app/s;->i:Landroid/support/v7/view/b;

    .line 314
    iput-object v0, p0, Landroid/support/v7/app/s;->j:Landroid/support/v7/view/b$a;
