...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/f;)V
    ...
    .line 106
    iput-object p1, p0, Landroid/support/v7/app/l;->q:Landroid/support/v4/view/x;

    .line 127
    new-instance p1, Landroid/support/v7/app/l$1;

    invoke-direct {p1, p0}, Landroid/support/v7/app/l$1;-><init>(Landroid/support/v7/app/l;)V

    iput-object p1, p0, Landroid/support/v7/app/l;->H:Ljava/lang/Runnable;
...
.method private a(Landroid/support/v7/app/l$d;Landroid/view/KeyEvent;)V
    ...
    .line 1133
    iget v3, p1, Landroid/support/v7/app/l$d;->a:I
    ...
    .line 1135
    invoke-virtual {p0, p1, v2}, Landroid/support/v7/app/l;->a(Landroid/support/v7/app/l$d;Z)V
    ...
    .line 1150
    :cond_5
    iget-object p2, p1, Landroid/support/v7/app/l$d;->g:Landroid/view/ViewGroup;
    ...
    iget-boolean p2, p1, Landroid/support/v7/app/l$d;->q:Z
    ...
    .line 1186
    :cond_6
    iget-object p2, p1, Landroid/support/v7/app/l$d;->i:Landroid/view/View;
    ...
    .line 1165
    :cond_b
    iget-object p2, p1, Landroid/support/v7/app/l$d;->h:Landroid/view/View;
    ...
    .line 1170
    :cond_c
    iget v3, p1, Landroid/support/v7/app/l$d;->b:I

    .line 1171
    iget-object v5, p1, Landroid/support/v7/app/l$d;->g:Landroid/view/ViewGroup;

    invoke-virtual {v5, v3}, Landroid/view/ViewGroup;->setBackgroundResource(I)V

    .line 1173
    iget-object v3, p1, Landroid/support/v7/app/l$d;->h:Landroid/view/View;
    ...
    iget-object v5, p1, Landroid/support/v7/app/l$d;->h:Landroid/view/View;

    invoke-virtual {v3, v5}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    .line 1177
    :cond_d
    iget-object v3, p1, Landroid/support/v7/app/l$d;->g:Landroid/view/ViewGroup;
    ...
    .line 1195
    :goto_2
    iput-boolean v1, p1, Landroid/support/v7/app/l$d;->n:Z
    ...
    iget v8, p1, Landroid/support/v7/app/l$d;->d:I

    iget v9, p1, Landroid/support/v7/app/l$d;->e:I
...
.method private a(Landroid/support/v7/view/menu/h;Z)V
    ...
    .line 1219
    iget-object p1, p0, Landroid/support/v7/app/l;->u:Landroid/support/v7/widget/DecorContentParent;
    ...
    .line 1225
    iget-object v2, p0, Landroid/support/v7/app/l;->u:Landroid/support/v7/widget/DecorContentParent;
    ...
    .line 1245
    :cond_1
    iget-object p2, p0, Landroid/support/v7/app/l;->u:Landroid/support/v7/widget/DecorContentParent;
    ...
    .line 1248
    iget-object p2, p2, Landroid/support/v7/app/l$d;->j:Landroid/support/v7/view/menu/h;
    ...
    .line 1228
    iget-boolean p2, p0, Landroid/support/v7/app/l;->r:Z

    if-eqz p2, :cond_3

    iget p2, p0, Landroid/support/v7/app/l;->s:I
    ...
    .line 1230
    iget-object p2, p0, Landroid/support/v7/app/l;->b:Landroid/view/Window;
    ...
    .line 1231
    iget-object p2, p0, Landroid/support/v7/app/l;->H:Ljava/lang/Runnable;
    ...
    .line 1238
    iget-object v0, p2, Landroid/support/v7/app/l$d;->j:Landroid/support/v7/view/menu/h;

    if-eqz v0, :cond_4

    iget-boolean v0, p2, Landroid/support/v7/app/l$d;->r:Z

    if-nez v0, :cond_4

    iget-object v0, p2, Landroid/support/v7/app/l$d;->i:Landroid/view/View;

    iget-object v2, p2, Landroid/support/v7/app/l$d;->j:Landroid/support/v7/view/menu/h;
    ...
    .line 1259
    invoke-direct {p0, p1, p2}, Landroid/support/v7/app/l;->a(Landroid/support/v7/app/l$d;Landroid/view/KeyEvent;)V
...
.method private a(Landroid/support/v7/app/l$d;ILandroid/view/KeyEvent;I)Z
    ...
    .line 1618
    iget-object p3, p0, Landroid/support/v7/app/l;->u:Landroid/support/v7/widget/DecorContentParent;

    if-nez p3, :cond_3

    .line 1619
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/app/l;->a(Landroid/support/v7/app/l$d;Z)V
...
.method private a(Landroid/view/ViewParent;)Z
    ...
    .line 1056
    invoke-static {v2}, Landroid/support/v4/view/t;->A(Landroid/view/View;)Z
...
.method private b(Landroid/support/v7/app/l$d;)Z
    ...
    .line 1266
    iget v1, p1, Landroid/support/v7/app/l$d;->a:I
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/app/l;->u:Landroid/support/v7/widget/DecorContentParent;
    ...
    .line 1299
    invoke-virtual {v1, p0}, Landroid/support/v7/view/menu/h;->setCallback(Landroid/support/v7/view/menu/h$a;)V
...
.method private b(Landroid/support/v7/app/l$d;Landroid/view/KeyEvent;)Z
    ...
    iput-object v3, p1, Landroid/support/v7/app/l$d;->i:Landroid/view/View;
    ...
    .line 1350
    iget-object v4, p0, Landroid/support/v7/app/l;->u:Landroid/support/v7/widget/DecorContentParent;
    ...
    iget-object v6, p1, Landroid/support/v7/app/l$d;->j:Landroid/support/v7/view/menu/h;

    iget-object v7, p0, Landroid/support/v7/app/l;->v:Landroid/support/v7/app/l$a;
    ...
    invoke-virtual {v4}, Landroid/support/v7/view/menu/h;->stopDispatchingItemsChanged()V
    ...
    .line 1379
    invoke-virtual {p1, v5}, Landroid/support/v7/app/l$d;->a(Landroid/support/v7/view/menu/h;)V
    ...
    iget-object p2, p0, Landroid/support/v7/app/l;->v:Landroid/support/v7/app/l$a;
    ...
    .line 1389
    :cond_e
    iput-boolean v1, p1, Landroid/support/v7/app/l$d;->r:Z
    ...
    iget-object v6, p1, Landroid/support/v7/app/l$d;->s:Landroid/os/Bundle;

    invoke-virtual {v4, v6}, Landroid/support/v7/view/menu/h;->restoreActionViewStates(Landroid/os/Bundle;)V

    .line 1400
    iput-object v5, p1, Landroid/support/v7/app/l$d;->s:Landroid/os/Bundle;
    ...
    iget-object v0, p0, Landroid/support/v7/app/l;->v:Landroid/support/v7/app/l$a;
    ...
    .line 1410
    :cond_11
    iget-object p1, p1, Landroid/support/v7/app/l$d;->j:Landroid/support/v7/view/menu/h;

    invoke-virtual {p1}, Landroid/support/v7/view/menu/h;->startDispatchingItemsChanged()V
    ...
    :goto_3
    iput-boolean p2, p1, Landroid/support/v7/app/l$d;->p:Z

    .line 1418
    iget-object p2, p1, Landroid/support/v7/app/l$d;->j:Landroid/support/v7/view/menu/h;

    iget-boolean v0, p1, Landroid/support/v7/app/l$d;->p:Z
    ...
    invoke-virtual {p2}, Landroid/support/v7/view/menu/h;->startDispatchingItemsChanged()V
...
.method private c(Landroid/support/v7/app/l$d;)Z
    ...
    .line 1323
    iget-object p1, p1, Landroid/support/v7/app/l$d;->h:Landroid/view/View;
...
.method private d(I)V
    ...
    iput p1, p0, Landroid/support/v7/app/l;->s:I

    .line 1629
    iget-boolean p1, p0, Landroid/support/v7/app/l;->r:Z

    if-nez p1, :cond_0

    .line 1630
    iget-object p1, p0, Landroid/support/v7/app/l;->b:Landroid/view/Window;

    invoke-virtual {p1}, Landroid/view/Window;->getDecorView()Landroid/view/View;

    move-result-object p1

    iget-object v0, p0, Landroid/support/v7/app/l;->H:Ljava/lang/Runnable;

    invoke-static {p1, v0}, Landroid/support/v4/view/t;->a(Landroid/view/View;Ljava/lang/Runnable;)V

    .line 1631
    iput-boolean v1, p0, Landroid/support/v7/app/l;->r:Z
...
.method private e(ILandroid/view/KeyEvent;)Z
    ...
    .line 1509
    :cond_2
    iget-boolean p1, v2, Landroid/support/v7/app/l$d;->o:Z

    if-nez p1, :cond_6

    iget-boolean p1, v2, Landroid/support/v7/app/l$d;->n:Z
    ...
    .line 1515
    :cond_3
    iget-boolean p1, v2, Landroid/support/v7/app/l$d;->m:Z

    if-eqz p1, :cond_5

    .line 1517
    iget-boolean p1, v2, Landroid/support/v7/app/l$d;->r:Z
    ...
    .line 1526
    invoke-direct {p0, v2, p2}, Landroid/support/v7/app/l;->a(Landroid/support/v7/app/l$d;Landroid/view/KeyEvent;)V
    ...
    .line 1514
    invoke-virtual {p0, v2, v0}, Landroid/support/v7/app/l;->a(Landroid/support/v7/app/l$d;Z)V

    :goto_2
    if-eqz p1, :cond_8

    .line 1533
    iget-object p2, p0, Landroid/support/v7/app/l;->a:Landroid/content/Context;
...
.method private x()V
    ...
    .line 342
    invoke-virtual {p0, v0, v0}, Landroid/support/v7/app/l;->a(IZ)Landroid/support/v7/app/l$d;
...
.method private y()Landroid/view/ViewGroup;
    ...
    .line 359
    invoke-virtual {p0, v3}, Landroid/support/v7/app/l;->c(I)Z
    ...
    iget-object v3, p0, Landroid/support/v7/app/l;->a:Landroid/content/Context;
    ...
    iput-object v1, p0, Landroid/support/v7/app/l;->u:Landroid/support/v7/widget/DecorContentParent;
    ...
    .line 436
    new-instance v1, Landroid/support/v7/app/l$2;

    invoke-direct {v1, p0}, Landroid/support/v7/app/l$2;-><init>(Landroid/support/v7/app/l;)V
    ...
    new-instance v3, Landroid/support/v7/app/l$3;

    invoke-direct {v3, p0}, Landroid/support/v7/app/l$3;-><init>(Landroid/support/v7/app/l;)V
    ...
    iput-object v1, p0, Landroid/support/v7/app/l;->z:Landroid/widget/TextView;
    ...
    .line 489
    iget-object v3, p0, Landroid/support/v7/app/l;->b:Landroid/view/Window;
    ...
    .line 512
    :cond_11
    iget-object v2, p0, Landroid/support/v7/app/l;->b:Landroid/view/Window;

    invoke-virtual {v2, v0}, Landroid/view/Window;->setContentView(Landroid/view/View;)V

    .line 514
    new-instance v2, Landroid/support/v7/app/l$4;

    invoke-direct {v2, p0}, Landroid/support/v7/app/l$4;-><init>(Landroid/support/v7/app/l;)V
...
.method protected a(IZ)Landroid/support/v7/app/l$d;
    ...
    .line 1586
    iget-object p2, p0, Landroid/support/v7/app/l;->E:[Landroid/support/v7/app/l$d;
    ...
    .line 1587
    new-array v0, v0, [Landroid/support/v7/app/l$d;
    ...
    .line 1591
    :cond_1
    iput-object v0, p0, Landroid/support/v7/app/l;->E:[Landroid/support/v7/app/l$d;
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/app/l$d;-><init>(I)V
...
.method a(Landroid/view/Menu;)Landroid/support/v7/app/l$d;
    ...
    .line 1577
    iget-object v4, v3, Landroid/support/v7/app/l$d;->j:Landroid/support/v7/view/menu/h;
...
.method public a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    iput-object p1, p0, Landroid/support/v7/app/l;->m:Landroid/support/v7/view/b;

    .line 700
    iget-object p1, p0, Landroid/support/v7/app/l;->m:Landroid/support/v7/view/b;

    if-eqz p1, :cond_2

    iget-object p1, p0, Landroid/support/v7/app/l;->e:Landroid/support/v7/app/f;
    ...
    invoke-interface {p1, v1}, Landroid/support/v7/app/f;->onSupportActionModeStarted(Landroid/support/v7/view/b;)V
...
.method public a(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 1003
    iget-object v0, p0, Landroid/support/v7/app/l;->L:Landroid/support/v7/app/AppCompatViewInflater;
    ...
    iput-object v2, p0, Landroid/support/v7/app/l;->L:Landroid/support/v7/app/AppCompatViewInflater;
    :try_end_0
    ...
    iput-object v0, p0, Landroid/support/v7/app/l;->L:Landroid/support/v7/app/AppCompatViewInflater;
    ...
    .line 1035
    iget-object v2, p0, Landroid/support/v7/app/l;->L:Landroid/support/v7/app/AppCompatViewInflater;

    sget-boolean v8, Landroid/support/v7/app/l;->t:Z
...
.method a(ILandroid/support/v7/app/l$d;Landroid/view/Menu;)V
    ...
    .line 1561
    iget-boolean p2, p2, Landroid/support/v7/app/l$d;->o:Z
    ...
    .line 1568
    iget-object p2, p0, Landroid/support/v7/app/l;->c:Landroid/view/Window$Callback;
...
.method public a(Landroid/os/Bundle;)V
    ...
    .line 154
    iget-object p1, p0, Landroid/support/v7/app/l;->c:Landroid/view/Window$Callback;
    ...
    .line 159
    iput-boolean v0, p0, Landroid/support/v7/app/l;->I:Z
...
.method a(Landroid/support/v7/app/l$d;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/l;->u:Landroid/support/v7/widget/DecorContentParent;
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/app/l;->a(Landroid/support/v7/view/menu/h;)V
    ...
    .line 1456
    iget-boolean v2, p1, Landroid/support/v7/app/l$d;->o:Z

    if-eqz v2, :cond_1

    iget-object v2, p1, Landroid/support/v7/app/l$d;->g:Landroid/view/ViewGroup;
    ...
    .line 1460
    iget p2, p1, Landroid/support/v7/app/l$d;->a:I

    invoke-virtual {p0, p2, p1, v1}, Landroid/support/v7/app/l;->a(ILandroid/support/v7/app/l$d;Landroid/view/Menu;)V

    :cond_1
    const/4 p2, 0x0

    .line 1464
    iput-boolean p2, p1, Landroid/support/v7/app/l$d;->m:Z

    .line 1465
    iput-boolean p2, p1, Landroid/support/v7/app/l$d;->n:Z

    .line 1466
    iput-boolean p2, p1, Landroid/support/v7/app/l$d;->o:Z

    .line 1469
    iput-object v1, p1, Landroid/support/v7/app/l$d;->h:Landroid/view/View;

    const/4 p2, 0x1

    .line 1473
    iput-boolean p2, p1, Landroid/support/v7/app/l$d;->q:Z

    .line 1475
    iget-object p2, p0, Landroid/support/v7/app/l;->F:Landroid/support/v7/app/l$d;

    if-ne p2, p1, :cond_2

    .line 1476
    iput-object v1, p0, Landroid/support/v7/app/l;->F:Landroid/support/v7/app/l$d;
...
.method public a(Landroid/support/v7/widget/Toolbar;)V
    ...
    .line 208
    iput-object v1, p0, Landroid/support/v7/app/l;->g:Landroid/view/MenuInflater;
    ...
    invoke-direct {v0, p1, v1, v2}, Landroid/support/v7/app/p;-><init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V

    .line 218
    iput-object v0, p0, Landroid/support/v7/app/l;->f:Landroid/support/v7/app/a;

    .line 219
    iget-object p1, p0, Landroid/support/v7/app/l;->b:Landroid/view/Window;

    invoke-virtual {v0}, Landroid/support/v7/app/p;->j()Landroid/view/Window$Callback;
...
.method a(ILandroid/view/KeyEvent;)Z
    ...
    .line 913
    :cond_0
    iget-object p1, p0, Landroid/support/v7/app/l;->F:Landroid/support/v7/app/l$d;
    ...
    invoke-direct {p0, p1, v0, p2, v1}, Landroid/support/v7/app/l;->a(Landroid/support/v7/app/l$d;ILandroid/view/KeyEvent;I)Z
    ...
    .line 929
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/app/l;->a(IZ)Landroid/support/v7/app/l$d;
    ...
    invoke-direct {p0, p1, v2, p2, v1}, Landroid/support/v7/app/l;->a(Landroid/support/v7/app/l$d;ILandroid/view/KeyEvent;I)Z

    move-result p2

    .line 932
    iput-boolean v0, p1, Landroid/support/v7/app/l$d;->m:Z
...
.method a(Landroid/view/KeyEvent;)Z
    ...
    .line 953
    invoke-virtual {p0, v0, p1}, Landroid/support/v7/app/l;->c(ILandroid/view/KeyEvent;)Z
    ...
    :cond_2
    invoke-virtual {p0, v0, p1}, Landroid/support/v7/app/l;->b(ILandroid/view/KeyEvent;)Z
...
.method b(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    .line 734
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/l;->e:Landroid/support/v7/app/f;
    ...
    iget-object v5, p0, Landroid/support/v7/app/l;->n:Landroid/support/v7/widget/ActionBarContextView;

    iget-object v6, p0, Landroid/support/v7/app/l;->o:Landroid/widget/PopupWindow;
    ...
    .line 826
    iget-object p1, p0, Landroid/support/v7/app/l;->n:Landroid/support/v7/widget/ActionBarContextView;
    ...
    .line 832
    iget-object p1, p0, Landroid/support/v7/app/l;->q:Landroid/support/v4/view/x;

    new-instance v0, Landroid/support/v7/app/l$6;

    invoke-direct {v0, p0}, Landroid/support/v7/app/l$6;-><init>(Landroid/support/v7/app/l;)V
    ...
    :cond_9
    :goto_4
    iget-object p1, p0, Landroid/support/v7/app/l;->o:Landroid/widget/PopupWindow;
    ...
    iget-object v0, p0, Landroid/support/v7/app/l;->p:Ljava/lang/Runnable;
    ...
    invoke-interface {p1, v0}, Landroid/support/v7/app/f;->onSupportActionModeStarted(Landroid/support/v7/view/b;)V
...
.method b(ILandroid/view/KeyEvent;)Z
    ...
    .line 959
    :cond_0
    invoke-direct {p0, v2, p2}, Landroid/support/v7/app/l;->e(ILandroid/view/KeyEvent;)Z

    return v1

    .line 962
    :cond_1
    iget-boolean p1, p0, Landroid/support/v7/app/l;->G:Z

    .line 963
    iput-boolean v2, p0, Landroid/support/v7/app/l;->G:Z
    ...
    .line 971
    invoke-virtual {p0, p2, v1}, Landroid/support/v7/app/l;->a(Landroid/support/v7/app/l$d;Z)V
...
.method c(ILandroid/view/KeyEvent;)Z
    ...
    .line 986
    :cond_0
    invoke-direct {p0, v2, p2}, Landroid/support/v7/app/l;->d(ILandroid/view/KeyEvent;)Z
...
.method e(I)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/app/l;->a(Landroid/support/v7/app/l$d;Z)V
...
.method f(I)V
    ...
    invoke-virtual {v3, v2}, Landroid/support/v7/view/menu/h;->saveActionViewStates(Landroid/os/Bundle;)V
    ...
    .line 1642
    iput-object v2, v1, Landroid/support/v7/app/l$d;->s:Landroid/os/Bundle;

    .line 1645
    :cond_0
    iget-object v2, v1, Landroid/support/v7/app/l$d;->j:Landroid/support/v7/view/menu/h;

    invoke-virtual {v2}, Landroid/support/v7/view/menu/h;->stopDispatchingItemsChanged()V
    ...
    .line 1648
    :cond_1
    iput-boolean v0, v1, Landroid/support/v7/app/l$d;->r:Z

    .line 1649
    iput-boolean v0, v1, Landroid/support/v7/app/l$d;->q:Z
    ...
    .line 1654
    invoke-virtual {p0, p1, p1}, Landroid/support/v7/app/l;->a(IZ)Landroid/support/v7/app/l$d;
    ...
    .line 1656
    iput-boolean p1, v0, Landroid/support/v7/app/l$d;->m:Z
...
.method g(I)I
    ...
    .line 1677
    iget-object v2, p0, Landroid/support/v7/app/l;->n:Landroid/support/v7/widget/ActionBarContextView;
    ...
    .line 1678
    iget-object v2, p0, Landroid/support/v7/app/l;->J:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Landroid/support/v7/app/l;->J:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, Landroid/support/v7/app/l;->K:Landroid/graphics/Rect;
    ...
    .line 1692
    iget-object v2, p0, Landroid/support/v7/app/l;->A:Landroid/view/View;
    ...
    iput-object v2, p0, Landroid/support/v7/app/l;->A:Landroid/view/View;
    ...
    .line 1696
    iget-object v2, p0, Landroid/support/v7/app/l;->y:Landroid/view/ViewGroup;
    ...
    :cond_a
    :goto_5
    iget-object v0, p0, Landroid/support/v7/app/l;->A:Landroid/view/View;
...
.method public m()V
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v7/app/s;-><init>(Landroid/app/Activity;Z)V
    ...
    invoke-direct {v0, v1}, Landroid/support/v7/app/s;-><init>(Landroid/app/Dialog;)V
...
.method public onMenuItemSelected(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)Z
    ...
    .line 672
    invoke-virtual {p1}, Landroid/support/v7/view/menu/h;->getRootMenu()Landroid/support/v7/view/menu/h;

    move-result-object p1

    invoke-virtual {p0, p1}, Landroid/support/v7/app/l;->a(Landroid/view/Menu;)Landroid/support/v7/app/l$d;
    ...
    .line 674
    iget p1, p1, Landroid/support/v7/app/l$d;->a:I
...
.method u()V
    ...
    .line 881
    iget-object v0, p0, Landroid/support/v7/app/l;->q:Landroid/support/v4/view/x;
