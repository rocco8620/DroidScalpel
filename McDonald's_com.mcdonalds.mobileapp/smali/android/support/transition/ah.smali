...
.method private static a(Landroid/animation/LayoutTransition;)V
    ...
    .line 116
    sget-boolean v0, Landroid/support/transition/ah;->e:Z
    ...
    sput-object v2, Landroid/support/transition/ah;->d:Ljava/lang/reflect/Method;

    .line 119
    sget-object v2, Landroid/support/transition/ah;->d:Ljava/lang/reflect/Method;
    ...
    .line 123
    :goto_0
    sput-boolean v0, Landroid/support/transition/ah;->e:Z

    .line 125
    :cond_0
    sget-object v0, Landroid/support/transition/ah;->d:Ljava/lang/reflect/Method;
...
# virtual methods
.method public a(Landroid/view/ViewGroup;)Landroid/support/transition/af;
    .locals 0

    .line 46
    invoke-static {p1}, Landroid/support/transition/ad;->a(Landroid/view/ViewGroup;)Landroid/support/transition/ad;
...
.method public a(Landroid/view/ViewGroup;Z)V
    ...
    .line 52
    sget-object v0, Landroid/support/transition/ah;->a:Landroid/animation/LayoutTransition;
    ...
    .line 53
    new-instance v0, Landroid/support/transition/ah$1;

    invoke-direct {v0, p0}, Landroid/support/transition/ah$1;-><init>(Landroid/support/transition/ah;)V

    sput-object v0, Landroid/support/transition/ah;->a:Landroid/animation/LayoutTransition;
    ...
    .line 70
    invoke-static {p2}, Landroid/support/transition/ah;->a(Landroid/animation/LayoutTransition;)V
    ...
    .line 77
    :cond_2
    sget-object p2, Landroid/support/transition/ah;->a:Landroid/animation/LayoutTransition;
    ...
    .line 82
    sget-boolean p2, Landroid/support/transition/ah;->c:Z
    ...
    sput-object p2, Landroid/support/transition/ah;->b:Ljava/lang/reflect/Field;

    .line 85
    sget-object p2, Landroid/support/transition/ah;->b:Ljava/lang/reflect/Field;
    ...
    .line 89
    :goto_0
    sput-boolean v1, Landroid/support/transition/ah;->c:Z
    ...
    .line 96
    :try_start_2
    sget-object v0, Landroid/support/transition/ah;->b:Ljava/lang/reflect/Field;
