...
.method private static a(Landroid/support/transition/v;)Z
    .locals 1

    .line 122
    invoke-virtual {p0}, Landroid/support/transition/v;->getTargetIds()Ljava/util/List;
    ...
    .line 123
    invoke-virtual {p0}, Landroid/support/transition/v;->getTargetNames()Ljava/util/List;
    ...
    .line 124
    invoke-virtual {p0}, Landroid/support/transition/v;->getTargetTypes()Ljava/util/List;
...
.method public a(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p1}, Landroid/support/transition/z;->a(Landroid/support/transition/v;)Landroid/support/transition/z;

    :cond_0
    if-eqz p2, :cond_1

    .line 135
    check-cast p2, Landroid/support/transition/v;

    invoke-virtual {v0, p2}, Landroid/support/transition/z;->a(Landroid/support/transition/v;)Landroid/support/transition/z;

    :cond_1
    if-eqz p3, :cond_2

    .line 138
    check-cast p3, Landroid/support/transition/v;

    invoke-virtual {v0, p3}, Landroid/support/transition/z;->a(Landroid/support/transition/v;)Landroid/support/transition/z;
...
.method public a(Landroid/view/ViewGroup;Ljava/lang/Object;)V
    ...
    invoke-static {p1, p2}, Landroid/support/transition/x;->a(Landroid/view/ViewGroup;Landroid/support/transition/v;)V
...
.method public a(Ljava/lang/Object;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/transition/v;->setEpicenterCallback(Landroid/support/transition/v$c;)V
...
.method public a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    invoke-virtual {p1, p2}, Landroid/support/transition/v;->setEpicenterCallback(Landroid/support/transition/v$c;)V
...
.method public a(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    .line 68
    invoke-virtual {p1}, Landroid/support/transition/z;->getTargets()Ljava/util/List;
...
.method public a(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v0, v9}, Landroid/support/transition/v;->addListener(Landroid/support/transition/v$d;)Landroid/support/transition/v;
...
.method public a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    .line 104
    invoke-virtual {p1}, Landroid/support/transition/z;->a()I
    ...
    .line 106
    invoke-virtual {p1, v1}, Landroid/support/transition/z;->b(I)Landroid/support/transition/v;
    ...
    .line 109
    :cond_1
    invoke-static {p1}, Landroid/support/transition/FragmentTransitionSupport;->a(Landroid/support/transition/v;)Z
    ...
    .line 110
    invoke-virtual {p1}, Landroid/support/transition/v;->getTargets()Ljava/util/List;
    ...
    invoke-virtual {p1, v2}, Landroid/support/transition/v;->addTarget(Landroid/view/View;)Landroid/support/transition/v;
...
.method public a(Ljava/lang/Object;)Z
    ...
    .line 42
    instance-of p1, p1, Landroid/support/transition/v;
...
.method public b(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 188
    invoke-virtual {p1, p2}, Landroid/support/transition/z;->a(Landroid/support/transition/v;)Landroid/support/transition/z;
    ...
    .line 189
    invoke-virtual {p1, p2}, Landroid/support/transition/z;->a(I)Landroid/support/transition/z;
    ...
    .line 196
    new-instance p2, Landroid/support/transition/z;

    invoke-direct {p2}, Landroid/support/transition/z;-><init>()V

    if-eqz p1, :cond_3

    .line 198
    invoke-virtual {p2, p1}, Landroid/support/transition/z;->a(Landroid/support/transition/v;)Landroid/support/transition/z;

    .line 200
    :cond_3
    invoke-virtual {p2, p3}, Landroid/support/transition/z;->a(Landroid/support/transition/v;)Landroid/support/transition/z;
...
.method public b(Ljava/lang/Object;Landroid/view/View;)V
    ...
    .line 292
    invoke-virtual {p1, p2}, Landroid/support/transition/v;->addTarget(Landroid/view/View;)Landroid/support/transition/v;
...
.method public b(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/transition/v;->addListener(Landroid/support/transition/v$d;)Landroid/support/transition/v;
...
.method public b(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/transition/v;->removeTarget(Landroid/view/View;)Landroid/support/transition/v;
...
.method public c(Ljava/lang/Object;Landroid/view/View;)V
    ...
    .line 300
    invoke-virtual {p1, p2}, Landroid/support/transition/v;->removeTarget(Landroid/view/View;)Landroid/support/transition/v;
