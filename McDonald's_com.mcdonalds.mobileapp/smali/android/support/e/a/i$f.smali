...
.method public constructor <init>()V
    ...
    .line 923
    sget-object v0, Landroid/support/e/a/i;->a:Landroid/graphics/PorterDuff$Mode;
...
.method public constructor <init>(Landroid/support/e/a/i$f;)V
    ...
    .line 952
    iget-boolean p1, p1, Landroid/support/e/a/i$f;->e:Z

    iput-boolean p1, p0, Landroid/support/e/a/i$f;->e:Z
...
.method public a(Landroid/graphics/ColorFilter;)Landroid/graphics/Paint;
    ...
    .line 975
    :cond_0
    iget-object v0, p0, Landroid/support/e/a/i$f;->l:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Landroid/support/e/a/i$f;->l:Landroid/graphics/Paint;
    ...
    .line 981
    iget-object p1, p0, Landroid/support/e/a/i$f;->l:Landroid/graphics/Paint;
...
.method public b(II)V
    ...
    iput-object p1, p0, Landroid/support/e/a/i$f;->f:Landroid/graphics/Bitmap;

    const/4 p1, 0x1

    .line 994
    iput-boolean p1, p0, Landroid/support/e/a/i$f;->k:Z
...
.method public b()Z
    ...
    iget-object v0, p0, Landroid/support/e/a/i$f;->g:Landroid/content/res/ColorStateList;

    iget-object v1, p0, Landroid/support/e/a/i$f;->c:Landroid/content/res/ColorStateList;

    if-ne v0, v1, :cond_0

    iget-object v0, p0, Landroid/support/e/a/i$f;->h:Landroid/graphics/PorterDuff$Mode;

    iget-object v1, p0, Landroid/support/e/a/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    if-ne v0, v1, :cond_0

    iget-boolean v0, p0, Landroid/support/e/a/i$f;->j:Z

    iget-boolean v1, p0, Landroid/support/e/a/i$f;->e:Z

    if-ne v0, v1, :cond_0

    iget v0, p0, Landroid/support/e/a/i$f;->i:I
...
.method public c()V
    ...
    iput-object v0, p0, Landroid/support/e/a/i$f;->g:Landroid/content/res/ColorStateList;

    .line 1022
    iget-object v0, p0, Landroid/support/e/a/i$f;->d:Landroid/graphics/PorterDuff$Mode;

    iput-object v0, p0, Landroid/support/e/a/i$f;->h:Landroid/graphics/PorterDuff$Mode;
    ...
    iput v0, p0, Landroid/support/e/a/i$f;->i:I

    .line 1024
    iget-boolean v0, p0, Landroid/support/e/a/i$f;->e:Z

    iput-boolean v0, p0, Landroid/support/e/a/i$f;->j:Z
...
.method public c(II)Z
    ...
    iget-object p1, p0, Landroid/support/e/a/i$f;->f:Landroid/graphics/Bitmap;
...
.method public newDrawable(Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
    ...
    .line 1039
    new-instance p1, Landroid/support/e/a/i;

    invoke-direct {p1, p0}, Landroid/support/e/a/i;-><init>(Landroid/support/e/a/i$f;)V
