...
.field private final mItemPool:Landroid/support/v4/g/k$a;
...
.field private final mSet:Landroid/support/transition/z;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mItemPool:Landroid/support/v4/g/k$a;
    ...
    iput-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mSet:Landroid/support/transition/z;

    .line 85
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mSet:Landroid/support/transition/z;

    invoke-virtual {v0, p1}, Landroid/support/transition/z;->a(I)Landroid/support/transition/z;

    .line 86
    iget-object p1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mSet:Landroid/support/transition/z;

    const-wide/16 v0, 0x73

    invoke-virtual {p1, v0, v1}, Landroid/support/transition/z;->a(J)Landroid/support/transition/z;
    ...
    invoke-virtual {p1, v0}, Landroid/support/transition/z;->a(Landroid/animation/TimeInterpolator;)Landroid/support/transition/z;
    ...
    invoke-virtual {p1, v0}, Landroid/support/transition/z;->a(Landroid/support/transition/v;)Landroid/support/transition/z;
...
.method static synthetic access$100(Landroid/support/design/internal/BottomNavigationMenuView;)Landroid/support/v7/view/menu/h;
    .locals 0

    .line 45
    iget-object p0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mMenu:Landroid/support/v7/view/menu/h;
...
.method private getNewItem()Landroid/support/design/internal/BottomNavigationItemView;
    ...
    .line 320
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mItemPool:Landroid/support/v4/g/k$a;
...
.method public buildMenuView()V
    ...
    .line 260
    iget-object v5, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mItemPool:Landroid/support/v4/g/k$a;
    ...
    .line 263
    :cond_0
    iget-object v0, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mMenu:Landroid/support/v7/view/menu/h;
    ...
    .line 271
    :goto_2
    iget-object v2, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mMenu:Landroid/support/v7/view/menu/h;
    ...
    .line 281
    iget-object v4, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mMenu:Landroid/support/v7/view/menu/h;
    ...
    invoke-virtual {v2, v4, v1}, Landroid/support/design/internal/BottomNavigationItemView;->initialize(Landroid/support/v7/view/menu/j;I)V
...
.method public initialize(Landroid/support/v7/view/menu/h;)V
    ...
    .line 105
    iput-object p1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mMenu:Landroid/support/v7/view/menu/h;
...
.method public updateMenuView()V
    ...
    .line 308
    iget-object v1, p0, Landroid/support/design/internal/BottomNavigationMenuView;->mSet:Landroid/support/transition/z;

    invoke-static {p0, v1}, Landroid/support/transition/x;->a(Landroid/view/ViewGroup;Landroid/support/transition/v;)V
    ...
    invoke-virtual {v3, v4, v2}, Landroid/support/design/internal/BottomNavigationItemView;->initialize(Landroid/support/v7/view/menu/j;I)V
