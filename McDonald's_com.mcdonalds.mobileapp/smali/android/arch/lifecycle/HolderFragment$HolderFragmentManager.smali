...
.field private mParentDestroyedCallback:Landroid/support/v4/app/m$a;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/HolderFragment$HolderFragmentManager;->mParentDestroyedCallback:Landroid/support/v4/app/m$a;
...
.method private static createHolderFragment(Landroid/support/v4/app/m;)Landroid/arch/lifecycle/HolderFragment;
    .locals 2
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/r;->a(Landroid/support/v4/app/Fragment;Ljava/lang/String;)Landroid/support/v4/app/r;

    move-result-object p0

    invoke-virtual {p0}, Landroid/support/v4/app/r;->d()I

    return-object v0
.end method

.method private static findHolderFragment(Landroid/support/v4/app/m;)Landroid/arch/lifecycle/HolderFragment;
    .locals 1
...
.method holderFragmentCreated(Landroid/support/v4/app/Fragment;)V
    ...
    iget-object v0, p0, Landroid/arch/lifecycle/HolderFragment$HolderFragmentManager;->mParentDestroyedCallback:Landroid/support/v4/app/m$a;
...
.method holderFragmentFor(Landroid/support/v4/app/Fragment;)Landroid/arch/lifecycle/HolderFragment;
    ...
    .line 178
    invoke-static {v0}, Landroid/arch/lifecycle/HolderFragment$HolderFragmentManager;->findHolderFragment(Landroid/support/v4/app/m;)Landroid/arch/lifecycle/HolderFragment;
    ...
    iget-object v2, p0, Landroid/arch/lifecycle/HolderFragment$HolderFragmentManager;->mParentDestroyedCallback:Landroid/support/v4/app/m$a;
    ...
    .line 189
    invoke-static {v0}, Landroid/arch/lifecycle/HolderFragment$HolderFragmentManager;->createHolderFragment(Landroid/support/v4/app/m;)Landroid/arch/lifecycle/HolderFragment;
...
.method holderFragmentFor(Landroid/support/v4/app/i;)Landroid/arch/lifecycle/HolderFragment;
    .locals 3
    ...
    .line 169
    invoke-virtual {p1}, Landroid/support/v4/app/i;->getApplication()Landroid/app/Application;
