...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/f$1;->V:[I

    const/4 v0, 0x1

    :try_start_0
    sget-object v1, Landroid/arch/lifecycle/f$1;->V:[I

    sget-object v2, Landroid/arch/lifecycle/c$b;->V:Landroid/arch/lifecycle/c$b;
    ...
    :try_start_1
    sget-object v2, Landroid/arch/lifecycle/f$1;->V:[I

    sget-object v3, Landroid/arch/lifecycle/c$b;->I:Landroid/arch/lifecycle/c$b;
    ...
    :try_start_2
    sget-object v3, Landroid/arch/lifecycle/f$1;->V:[I

    sget-object v4, Landroid/arch/lifecycle/c$b;->Z:Landroid/arch/lifecycle/c$b;
    ...
    sget-object v5, Landroid/arch/lifecycle/c$b;->B:Landroid/arch/lifecycle/c$b;
    ...
    :try_start_4
    sget-object v5, Landroid/arch/lifecycle/f$1;->V:[I

    sget-object v6, Landroid/arch/lifecycle/c$b;->Code:Landroid/arch/lifecycle/c$b;
    ...
    sput-object v5, Landroid/arch/lifecycle/f$1;->Code:[I

    :try_start_5
    sget-object v5, Landroid/arch/lifecycle/f$1;->Code:[I
