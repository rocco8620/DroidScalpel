...
.field private V:Landroid/support/v7/view/menu/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/view/menu/ExpandedMenuView;->Code:[I
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;B)V
    ...
    sget-object p3, Landroid/support/v7/view/menu/ExpandedMenuView;->Code:[I

    const/4 v0, 0x0

    const v1, 0x1010074

    invoke-static {p1, p2, p3, v1, v0}, Landroid/support/v7/widget/at;->Code(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/at;

    move-result-object p1

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/at;->C(I)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/at;->Code(I)Landroid/graphics/drawable/Drawable;
...
.method public final Code(Landroid/support/v7/view/menu/h;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ExpandedMenuView;->V:Landroid/support/v7/view/menu/h;
...
.method public final Code(Landroid/support/v7/view/menu/j;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ExpandedMenuView;->V:Landroid/support/v7/view/menu/h;
...
.method public final getWindowAnimations()I
    ...
    iget v0, p0, Landroid/support/v7/view/menu/ExpandedMenuView;->I:I
...
.method public final onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {p0, p1}, Landroid/support/v7/view/menu/ExpandedMenuView;->Code(Landroid/support/v7/view/menu/j;)Z
