...
# instance fields
.field B:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.field I:Landroid/support/v7/view/menu/h$b;
...
.method private C()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->S:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_1

    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->V:Landroid/support/v7/view/menu/j;

    invoke-virtual {v2}, Landroid/support/v7/view/menu/j;->D()Z

    move-result v2

    if-eqz v2, :cond_0

    iget-boolean v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->D:Z
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->C:Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->V:Landroid/support/v7/view/menu/j;
    ...
    :goto_3
    invoke-static {p0, v1}, Landroid/support/v7/widget/av;->Code(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    :cond_6
    invoke-static {p0, v2}, Landroid/support/v7/widget/av;->Code(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final Code(Landroid/support/v7/view/menu/j;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->V:Landroid/support/v7/view/menu/j;
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->F:Landroid/support/v7/widget/ag;
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->F:Landroid/support/v7/widget/ag;
...
.method public final I()Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->V()Z
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->I:Landroid/support/v7/view/menu/h$b;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->V:Landroid/support/v7/view/menu/j;

    invoke-interface {p1, v0}, Landroid/support/v7/view/menu/h$b;->Code(Landroid/support/v7/view/menu/j;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->D:Z
...
.method public onMeasure(II)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->S:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->S:Landroid/graphics/drawable/Drawable;
...
.method public setExpandedFormat(Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->V:Landroid/support/v7/view/menu/j;

    if-eqz p1, :cond_0

    iget-object p1, p1, Landroid/support/v7/view/menu/j;->Z:Landroid/support/v7/view/menu/h;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->S:Landroid/graphics/drawable/Drawable;
...
.method public setItemInvoker(Landroid/support/v7/view/menu/h$b;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->I:Landroid/support/v7/view/menu/h$b;
...
.method public setPopupCallback(Landroid/support/v7/view/menu/ActionMenuItemView$b;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->B:Landroid/support/v7/view/menu/ActionMenuItemView$b;
