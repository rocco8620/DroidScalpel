...
# instance fields
.field private final C:Landroid/support/v7/widget/f;

.field Code:Landroid/support/v7/widget/x$b;
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/x;->C:Landroid/support/v7/widget/f;

    sget v2, Landroid/support/v7/a/a$j;->Spinner_popupTheme:I

    invoke-virtual {v0, v2, v1}, Landroid/support/v7/widget/at;->S(II)I
    ...
    :goto_0
    iput-object v4, p0, Landroid/support/v7/widget/x;->S:Landroid/content/Context;

    iget-object v2, p0, Landroid/support/v7/widget/x;->S:Landroid/content/Context;
    ...
    invoke-static {v2, p2, v5, p3, v1}, Landroid/support/v7/widget/at;->Code(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/at;
    ...
    invoke-virtual {v1, v2, v5}, Landroid/support/v7/widget/at;->C(II)I

    move-result v2

    iput v2, p0, Landroid/support/v7/widget/x;->V:I

    sget v2, Landroid/support/v7/a/a$j;->Spinner_android_popupBackground:I

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/at;->Code(I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    invoke-virtual {p4, v2}, Landroid/support/v7/widget/x$b;->Code(Landroid/graphics/drawable/Drawable;)V

    sget v2, Landroid/support/v7/a/a$j;->Spinner_android_prompt:I

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/at;->Z(I)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p4, Landroid/support/v7/widget/x$b;->Code:Ljava/lang/CharSequence;

    iget-object v1, v1, Landroid/support/v7/widget/at;->Code:Landroid/content/res/TypedArray;

    invoke-virtual {v1}, Landroid/content/res/TypedArray;->recycle()V

    iput-object p4, p0, Landroid/support/v7/widget/x;->Code:Landroid/support/v7/widget/x$b;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/x;->F:Landroid/support/v7/widget/ag;
    ...
    iget-object v1, v0, Landroid/support/v7/widget/at;->Code:Landroid/content/res/TypedArray;
    ...
    :cond_6
    iget-object p1, v0, Landroid/support/v7/widget/at;->Code:Landroid/content/res/TypedArray;

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    iput-boolean v4, p0, Landroid/support/v7/widget/x;->L:Z
    ...
    iput-object v3, p0, Landroid/support/v7/widget/x;->D:Landroid/widget/SpinnerAdapter;

    :cond_7
    iget-object p1, p0, Landroid/support/v7/widget/x;->C:Landroid/support/v7/widget/f;
...
# virtual methods
.method final Code(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
    .locals 10
...
.method protected final drawableStateChanged()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->C:Landroid/support/v7/widget/f;
...
.method public final getDropDownHorizontalOffset()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->Code:Landroid/support/v7/widget/x$b;

    if-eqz v0, :cond_0

    iget v0, v0, Landroid/support/v7/widget/ai;->S:I
...
.method public final getDropDownVerticalOffset()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/x$b;->S()I
...
.method public final getPopupContext()Landroid/content/Context;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->S:Landroid/content/Context;
...
.method public final getPrompt()Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/x$b;->Code:Ljava/lang/CharSequence;
...
.method protected final onMeasure(II)V
    ...
    iget-object p2, p0, Landroid/support/v7/widget/x;->Code:Landroid/support/v7/widget/x$b;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/x;->Code(Landroid/widget/SpinnerAdapter;Landroid/graphics/drawable/Drawable;)I
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->F:Landroid/support/v7/widget/ag;
...
.method public final setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/x;->Code:Landroid/support/v7/widget/x$b;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/x$b;->Code(Landroid/widget/ListAdapter;)V
...
.method public final setDropDownVerticalOffset(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/x$b;->Code(I)V
...
.method public final setDropDownWidth(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/x;->V:I
...
.method public final setPopupBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/x$b;->Code(Landroid/graphics/drawable/Drawable;)V
...
.method public final setPrompt(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, v0, Landroid/support/v7/widget/x$b;->Code:Ljava/lang/CharSequence;
