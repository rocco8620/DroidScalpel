...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput v0, p0, Landroid/support/v7/widget/ak$a;->V:I
    ...
    :cond_0
    iput v1, p0, Landroid/support/v7/widget/ak$a;->V:I
...
# virtual methods
.method public final bridge synthetic Code(IIIII)I
    .locals 0

    invoke-super/range {p0 .. p5}, Landroid/support/v7/widget/ae;->Code(IIIII)I
...
.method public final bridge synthetic Code(Landroid/view/MotionEvent;I)Z
    .locals 0

    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/ae;->Code(Landroid/view/MotionEvent;I)Z
...
.method public final onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ak$a;->B:Landroid/support/v7/widget/aj;
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/view/menu/g;->Code(I)Landroid/support/v7/view/menu/j;

    move-result-object v2

    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/ak$a;->C:Landroid/view/MenuItem;

    if-eq v1, v2, :cond_3

    iget-object v0, v0, Landroid/support/v7/view/menu/g;->Code:Landroid/support/v7/view/menu/h;

    if-eqz v1, :cond_2

    iget-object v3, p0, Landroid/support/v7/widget/ak$a;->B:Landroid/support/v7/widget/aj;

    invoke-interface {v3, v0, v1}, Landroid/support/v7/widget/aj;->Code(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V

    :cond_2
    iput-object v2, p0, Landroid/support/v7/widget/ak$a;->C:Landroid/view/MenuItem;

    if-eqz v2, :cond_3

    iget-object v1, p0, Landroid/support/v7/widget/ak$a;->B:Landroid/support/v7/widget/aj;

    invoke-interface {v1, v0, v2}, Landroid/support/v7/widget/aj;->V(Landroid/support/v7/view/menu/h;Landroid/view/MenuItem;)V
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroid/support/v7/widget/ak$a;->V:I
    ...
    iget-object p1, p1, Landroid/support/v7/view/menu/g;->Code:Landroid/support/v7/view/menu/h;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Landroid/support/v7/view/menu/h;->Code(Z)V
...
.method public final setHoverListener(Landroid/support/v7/widget/aj;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ak$a;->B:Landroid/support/v7/widget/aj;
