...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, p2}, Landroid/support/v4/f/p;->Code(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    iput p2, p0, Landroid/support/v7/widget/ActionBarContextView;->f:I
    ...
    iput p2, p0, Landroid/support/v7/widget/ActionBarContextView;->g:I

    sget p2, Landroid/support/v7/a/a$j;->ActionMode_height:I

    invoke-virtual {p1, p2, v1}, Landroid/support/v7/widget/at;->C(II)I
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/at;->S(II)I
...
.method private Z()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->e:Landroid/widget/TextView;

    iget v0, p0, Landroid/support/v7/widget/ActionBarContextView;->f:I

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Landroid/widget/TextView;

    invoke-virtual {p0}, Landroid/support/v7/widget/ActionBarContextView;->getContext()Landroid/content/Context;

    move-result-object v1

    iget v2, p0, Landroid/support/v7/widget/ActionBarContextView;->f:I

    invoke-virtual {v0, v1, v2}, Landroid/widget/TextView;->setTextAppearance(Landroid/content/Context;I)V

    :cond_0
    iget v0, p0, Landroid/support/v7/widget/ActionBarContextView;->g:I

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->e:Landroid/widget/TextView;

    invoke-virtual {p0}, Landroid/support/v7/widget/ActionBarContextView;->getContext()Landroid/content/Context;

    move-result-object v1

    iget v2, p0, Landroid/support/v7/widget/ActionBarContextView;->g:I
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->L:Ljava/lang/CharSequence;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->e:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/widget/LinearLayout;
...
# virtual methods
.method public final bridge synthetic Code(IJ)Landroid/support/v4/f/s;
    .locals 0

    invoke-super {p0, p1, p2, p3}, Landroid/support/v7/widget/a;->Code(IJ)Landroid/support/v4/f/s;
...
.method public final Code(Landroid/support/v7/view/b;)V
    ...
    iget v1, p0, Landroid/support/v7/widget/ActionBarContextView;->h:I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->B:Landroid/support/v7/widget/c;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->B:Landroid/support/v7/widget/c;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ActionBarContextView;->B:Landroid/support/v7/widget/c;

    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->V:Landroid/content/Context;

    invoke-virtual {p1, v1, v2}, Landroid/support/v7/view/menu/h;->Code(Landroid/support/v7/view/menu/o;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->B:Landroid/support/v7/widget/c;

    invoke-virtual {p1, p0}, Landroid/support/v7/widget/c;->Code(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/p;

    move-result-object p1

    check-cast p1, Landroid/support/v7/widget/ActionMenuView;

    iput-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->I:Landroid/support/v7/widget/ActionMenuView;

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->I:Landroid/support/v7/widget/ActionMenuView;

    const/4 v1, 0x0

    invoke-static {p1, v1}, Landroid/support/v4/f/p;->Code(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final I()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->I:Landroid/support/v7/widget/ActionMenuView;
...
.method public getSubtitle()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->L:Ljava/lang/CharSequence;
...
.method public onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/c;->S()Z
...
.method protected onLayout(ZIIII)V
    ...
    :goto_2
    invoke-static {v0, v3, p1}, Landroid/support/v7/widget/ActionBarContextView;->Code(IIZ)I

    move-result v0

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->a:Landroid/view/View;

    invoke-static {v3, v0, v1, p5, p1}, Landroid/support/v7/widget/ActionBarContextView;->Code(Landroid/view/View;IIIZ)I

    move-result v3

    add-int/2addr v0, v3

    invoke-static {v0, p3, p1}, Landroid/support/v7/widget/ActionBarContextView;->Code(IIZ)I

    move-result v0

    :cond_3
    iget-object p3, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/widget/LinearLayout;
    ...
    invoke-static {p3, v0, v1, p5, p1}, Landroid/support/v7/widget/ActionBarContextView;->Code(Landroid/view/View;IIIZ)I
    ...
    :goto_3
    iget-object p3, p0, Landroid/support/v7/widget/ActionBarContextView;->I:Landroid/support/v7/widget/ActionMenuView;
    ...
    invoke-static {p3, p2, v1, p5, p1}, Landroid/support/v7/widget/ActionBarContextView;->Code(Landroid/view/View;IIIZ)I
...
.method protected onMeasure(II)V
    ...
    iget p2, p0, Landroid/support/v7/widget/ActionBarContextView;->C:I
    ...
    invoke-static {v6, v2, v5}, Landroid/support/v7/widget/ActionBarContextView;->Code(Landroid/view/View;II)I
    ...
    :cond_1
    iget-object v6, p0, Landroid/support/v7/widget/ActionBarContextView;->I:Landroid/support/v7/widget/ActionMenuView;
    ...
    :cond_2
    iget-object v6, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/widget/LinearLayout;
    ...
    iget-boolean v8, p0, Landroid/support/v7/widget/ActionBarContextView;->F:Z
    ...
    iget-object v8, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/widget/LinearLayout;

    invoke-virtual {v8, v6, v5}, Landroid/widget/LinearLayout;->measure(II)V

    iget-object v5, p0, Landroid/support/v7/widget/ActionBarContextView;->c:Landroid/widget/LinearLayout;
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->L:Ljava/lang/CharSequence;

    invoke-direct {p0}, Landroid/support/v7/widget/ActionBarContextView;->Z()V
...
.method public setTitleOptional(Z)V
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/ActionBarContextView;->F:Z
    ...
    :cond_0
    iput-boolean p1, p0, Landroid/support/v7/widget/ActionBarContextView;->F:Z
