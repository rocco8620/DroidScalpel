...
# instance fields
.field final synthetic Code:Landroid/support/v7/widget/SearchView;
...
.method constructor <init>(Landroid/support/v7/widget/SearchView;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/SearchView$6;->Code:Landroid/support/v7/widget/SearchView;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView$6;->Code:Landroid/support/v7/widget/SearchView;

    iget-object v0, v0, Landroid/support/v7/widget/SearchView;->I:Landroid/widget/ImageView;

    if-ne p1, v0, :cond_0

    iget-object p1, p0, Landroid/support/v7/widget/SearchView$6;->Code:Landroid/support/v7/widget/SearchView;

    invoke-virtual {p1}, Landroid/support/v7/widget/SearchView;->S()V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/SearchView;->S:Landroid/widget/ImageView;

    if-ne p1, v0, :cond_d

    iget-object p1, p0, Landroid/support/v7/widget/SearchView$6;->Code:Landroid/support/v7/widget/SearchView;

    iget-object v0, p1, Landroid/support/v7/widget/SearchView;->e:Landroid/app/SearchableInfo;
    ...
    iget-object v1, p1, Landroid/support/v7/widget/SearchView;->D:Landroid/content/Intent;
    ...
    iget-object v1, p1, Landroid/support/v7/widget/SearchView;->L:Landroid/content/Intent;
    ...
    iget-object v6, p1, Landroid/support/v7/widget/SearchView;->f:Landroid/os/Bundle;

    if-eqz v6, :cond_5

    const-string v6, "app_data"

    iget-object v7, p1, Landroid/support/v7/widget/SearchView;->f:Landroid/os/Bundle;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/SearchView;->Code:Landroid/support/v7/widget/SearchView$SearchAutoComplete;
