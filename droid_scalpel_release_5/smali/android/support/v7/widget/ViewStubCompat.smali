...
.field private C:Landroid/support/v7/widget/ViewStubCompat$a;
...
.method private constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;B)V
    ...
    iput p3, p0, Landroid/support/v7/widget/ViewStubCompat;->Code:I
    ...
    iput p2, p0, Landroid/support/v7/widget/ViewStubCompat;->V:I
    ...
    iput p2, p0, Landroid/support/v7/widget/ViewStubCompat;->Code:I
...
# virtual methods
.method public final Code()Landroid/view/View;
    .locals 4
    ...
    iget v1, p0, Landroid/support/v7/widget/ViewStubCompat;->Code:I

    if-eqz v1, :cond_3

    check-cast v0, Landroid/view/ViewGroup;

    iget-object v1, p0, Landroid/support/v7/widget/ViewStubCompat;->B:Landroid/view/LayoutInflater;
    ...
    :goto_0
    iget v2, p0, Landroid/support/v7/widget/ViewStubCompat;->Code:I
    ...
    iget v2, p0, Landroid/support/v7/widget/ViewStubCompat;->V:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ViewStubCompat;->I:Ljava/lang/ref/WeakReference;
...
.method public final getInflatedId()I
    ...
    iget v0, p0, Landroid/support/v7/widget/ViewStubCompat;->V:I
...
.method public final getLayoutInflater()Landroid/view/LayoutInflater;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ViewStubCompat;->B:Landroid/view/LayoutInflater;
...
.method public final getLayoutResource()I
    ...
    iget v0, p0, Landroid/support/v7/widget/ViewStubCompat;->Code:I
...
.method public final setInflatedId(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/ViewStubCompat;->V:I
...
.method public final setLayoutInflater(Landroid/view/LayoutInflater;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ViewStubCompat;->B:Landroid/view/LayoutInflater;
...
.method public final setLayoutResource(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/ViewStubCompat;->Code:I
...
.method public final setOnInflateListener(Landroid/support/v7/widget/ViewStubCompat$a;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ViewStubCompat;->C:Landroid/support/v7/widget/ViewStubCompat$a;
...
.method public final setVisibility(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ViewStubCompat;->I:Ljava/lang/ref/WeakReference;
    ...
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/widget/ViewStubCompat;->Code()Landroid/view/View;
