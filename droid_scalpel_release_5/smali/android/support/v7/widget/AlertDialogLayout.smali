...
.method protected onLayout(ZIIII)V
    ...
    iget v7, v6, Landroid/support/v7/widget/ah$a;->F:I
    ...
    invoke-static {v7, v8}, Landroid/support/v4/f/d;->Code(II)I
    ...
    iget v7, v6, Landroid/support/v7/widget/ah$a;->leftMargin:I
    ...
    iget v8, v6, Landroid/support/v7/widget/ah$a;->leftMargin:I

    add-int/2addr v7, v8

    :goto_2
    iget v8, v6, Landroid/support/v7/widget/ah$a;->rightMargin:I

    sub-int/2addr v7, v8

    :goto_3
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/AlertDialogLayout;->Code(I)Z
    ...
    :cond_6
    iget v8, v6, Landroid/support/v7/widget/ah$a;->topMargin:I
    ...
    iget v3, v6, Landroid/support/v7/widget/ah$a;->bottomMargin:I
...
.method protected onMeasure(II)V
    ...
    :goto_3
    invoke-static {v13}, Landroid/support/v4/f/p;->I(Landroid/view/View;)I
    ...
    check-cast v12, Landroid/support/v7/widget/ah$a;

    iget v0, v12, Landroid/support/v7/widget/ah$a;->width:I

    const/4 v2, -0x1

    if-ne v0, v2, :cond_12

    iget v14, v12, Landroid/support/v7/widget/ah$a;->height:I

    invoke-virtual {v1}, Landroid/view/View;->getMeasuredHeight()I

    move-result v0

    iput v0, v12, Landroid/support/v7/widget/ah$a;->height:I
    ...
    iput v14, v12, Landroid/support/v7/widget/ah$a;->height:I
