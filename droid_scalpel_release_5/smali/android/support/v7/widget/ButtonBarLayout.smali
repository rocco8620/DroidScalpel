...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p0, Landroid/support/v7/widget/ButtonBarLayout;->V:I

    const/4 v0, 0x0

    iput v0, p0, Landroid/support/v7/widget/ButtonBarLayout;->I:I
    ...
    iput-boolean p2, p0, Landroid/support/v7/widget/ButtonBarLayout;->Code:Z
...
.method public getMinimumHeight()I
    ...
    iget v0, p0, Landroid/support/v7/widget/ButtonBarLayout;->I:I
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, p0, Landroid/support/v7/widget/ButtonBarLayout;->Code:Z

    const/4 v2, 0x0

    if-eqz v1, :cond_1

    iget v1, p0, Landroid/support/v7/widget/ButtonBarLayout;->V:I

    if-le v0, v1, :cond_0

    invoke-direct {p0}, Landroid/support/v7/widget/ButtonBarLayout;->Code()Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/ButtonBarLayout;->Code:Z
    ...
    :cond_5
    invoke-direct {p0, v2}, Landroid/support/v7/widget/ButtonBarLayout;->Code(I)I
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ButtonBarLayout;->Code(I)I
    ...
    :cond_8
    :goto_2
    invoke-static {p0}, Landroid/support/v4/f/p;->I(Landroid/view/View;)I
...
.method public setAllowStacking(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/ButtonBarLayout;->Code:Z

    iget-boolean p1, p0, Landroid/support/v7/widget/ButtonBarLayout;->Code:Z
