...
.field Code:Landroid/support/v7/widget/d;

.field final synthetic I:Landroid/support/v7/widget/ActivityChooserView;
...
.method public final Code()I
    ...
    iget v0, p0, Landroid/support/v7/widget/ActivityChooserView$a;->Z:I

    const v1, 0x7fffffff

    iput v1, p0, Landroid/support/v7/widget/ActivityChooserView$a;->Z:I
    ...
    :cond_0
    iput v0, p0, Landroid/support/v7/widget/ActivityChooserView$a;->Z:I
...
.method public final Code(I)V
    ...
    iput p1, p0, Landroid/support/v7/widget/ActivityChooserView$a;->Z:I
...
.method public final Code(ZZ)V
    .locals 1

    iget-boolean v0, p0, Landroid/support/v7/widget/ActivityChooserView$a;->V:Z
    ...
    :cond_0
    iput-boolean p1, p0, Landroid/support/v7/widget/ActivityChooserView$a;->V:Z
...
.method public final getCount()I
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView$a;->Code:Landroid/support/v7/widget/d;

    invoke-virtual {v0}, Landroid/support/v7/widget/d;->Code()I

    move-result v0

    iget-boolean v1, p0, Landroid/support/v7/widget/ActivityChooserView$a;->V:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView$a;->Code:Landroid/support/v7/widget/d;

    invoke-virtual {v1}, Landroid/support/v7/widget/d;->V()Landroid/content/pm/ResolveInfo;
    ...
    :cond_0
    iget v1, p0, Landroid/support/v7/widget/ActivityChooserView$a;->Z:I
...
.method public final getItem(I)Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/d;->V()Landroid/content/pm/ResolveInfo;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/d;->Code(I)Landroid/content/pm/ResolveInfo;
...
.method public final getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    :cond_0
    iget-object p1, p0, Landroid/support/v7/widget/ActivityChooserView$a;->I:Landroid/support/v7/widget/ActivityChooserView;
    ...
    iget-object p3, p0, Landroid/support/v7/widget/ActivityChooserView$a;->I:Landroid/support/v7/widget/ActivityChooserView;
    ...
    :cond_2
    iget-object p2, p0, Landroid/support/v7/widget/ActivityChooserView$a;->I:Landroid/support/v7/widget/ActivityChooserView;
    ...
    iget-boolean p3, p0, Landroid/support/v7/widget/ActivityChooserView$a;->V:Z
