...
.method private B()Landroid/support/v7/app/e;
    ...
    invoke-static {p0, p0}, Landroid/support/v7/app/e;->Code(Landroid/app/Activity;Landroid/support/v7/app/d;)Landroid/support/v7/app/e;
...
.method private Z()Z
    ...
    invoke-static {p0}, Landroid/support/v4/app/s;->Code(Landroid/app/Activity;)Landroid/content/Intent;
    ...
    invoke-static {p0}, Landroid/support/v4/app/x;->Code(Landroid/content/Context;)Landroid/support/v4/app/x;

    move-result-object v0

    move-object v2, p0

    check-cast v2, Landroid/support/v4/app/x$a;

    invoke-interface {v2}, Landroid/support/v4/app/x$a;->a_()Landroid/content/Intent;
    ...
    iget-object v4, v0, Landroid/support/v4/app/x;->V:Landroid/content/Context;
    ...
    :cond_3
    invoke-virtual {v0, v4}, Landroid/support/v4/app/x;->Code(Landroid/content/ComponentName;)Landroid/support/v4/app/x;

    iget-object v4, v0, Landroid/support/v4/app/x;->Code:Ljava/util/ArrayList;

    invoke-virtual {v4, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    :cond_4
    iget-object v2, v0, Landroid/support/v4/app/x;->Code:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Landroid/support/v4/app/x;->V:Landroid/content/Context;

    invoke-static {v0, v2}, Landroid/support/v4/a/a;->Code(Landroid/content/Context;[Landroid/content/Intent;)Z

    :try_start_0
    invoke-static {p0}, Landroid/support/v4/app/a;->Code(Landroid/app/Activity;)V
    :try_end_0
...
.method public final I()V
    ...
    invoke-direct {p0}, Landroid/support/v7/app/c;->B()Landroid/support/v7/app/e;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/v7/app/e;->S()V
...
.method public addContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/app/e;->V(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public closeOptionsMenu()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/e;->Code()Landroid/support/v7/app/a;
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v1}, Landroid/support/v7/app/e;->Code()Landroid/support/v7/app/a;
    ...
    invoke-virtual {v1, p1}, Landroid/support/v7/app/a;->Code(Landroid/view/KeyEvent;)Z
...
.method public findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/e;->Code(I)Landroid/view/View;
...
.method public getMenuInflater()Landroid/view/MenuInflater;
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/e;->V()Landroid/view/MenuInflater;
...
.method public getResources()Landroid/content/res/Resources;
    ...
    iget-object v0, p0, Landroid/support/v7/app/c;->b:Landroid/content/res/Resources;
    ...
    iput-object v0, p0, Landroid/support/v7/app/c;->b:Landroid/content/res/Resources;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/e;->Code(Landroid/content/res/Configuration;)V
    ...
    iget-object v1, p0, Landroid/support/v7/app/c;->b:Landroid/content/res/Resources;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/e;->Code(Landroid/os/Bundle;)V

    invoke-virtual {v0}, Landroid/support/v7/app/e;->L()Z

    move-result v0

    if-eqz v0, :cond_1

    iget v0, p0, Landroid/support/v7/app/c;->a:I
    ...
    iget v1, p0, Landroid/support/v7/app/c;->a:I
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-virtual {p1}, Landroid/support/v7/app/e;->Code()Landroid/support/v7/app/a;
    ...
    invoke-virtual {p1}, Landroid/support/v7/app/a;->Code()I
    ...
    invoke-direct {p0}, Landroid/support/v7/app/c;->Z()Z
...
.method protected onPostCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p1}, Landroid/support/v7/app/e;->I()V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/e;->V(Landroid/os/Bundle;)V
...
.method protected onTitleChanged(Ljava/lang/CharSequence;I)V
    ...
    invoke-virtual {p2, p1}, Landroid/support/v7/app/e;->Code(Ljava/lang/CharSequence;)V
...
.method public setContentView(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/e;->V(I)V
...
.method public setContentView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/e;->Code(Landroid/view/View;)V
...
.method public setContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/app/e;->Code(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public setTheme(I)V
    ...
    iput p1, p0, Landroid/support/v7/app/c;->a:I
