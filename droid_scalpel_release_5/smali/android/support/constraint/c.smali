...
.method static constructor <clinit>()V
    ...
    sput-object v1, Landroid/support/constraint/c;->V:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/constraint/c;->Code:Ljava/util/HashMap;

    return-void
.end method

.method private static Code(Landroid/content/res/TypedArray;II)I
    .locals 1
...
.method static Code(Landroid/support/constraint/c$a;Landroid/content/res/TypedArray;)V
    .locals 6
    ...
    :pswitch_1
    iget-boolean v3, p0, Landroid/support/constraint/c$a;->aq:Z

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Landroid/support/constraint/c$a;->aq:Z
    ...
    iput-object v2, p0, Landroid/support/constraint/c$a;->au:Ljava/lang/String;

    goto/16 :goto_2

    :pswitch_3
    iget v3, p0, Landroid/support/constraint/c$a;->ar:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    iput v2, p0, Landroid/support/constraint/c$a;->ar:I
    ...
    iput v2, p0, Landroid/support/constraint/c$a;->ao:F

    goto/16 :goto_2

    :pswitch_7
    iget v3, p0, Landroid/support/constraint/c$a;->p:F
    ...
    invoke-static {p1, v2, v3}, Landroid/support/constraint/c;->Code(Landroid/content/res/TypedArray;II)I
    ...
    iput-boolean v3, p0, Landroid/support/constraint/c$a;->R:Z

    iget v3, p0, Landroid/support/constraint/c$a;->T:F
    ...
    :pswitch_18
    iget v3, p0, Landroid/support/constraint/c$a;->M:F
    ...
    :pswitch_19
    iget v3, p0, Landroid/support/constraint/c$a;->N:F
    ...
    :pswitch_1a
    iget v3, p0, Landroid/support/constraint/c$a;->Z:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v2

    iput v2, p0, Landroid/support/constraint/c$a;->Z:I

    goto/16 :goto_2

    :pswitch_1b
    iget v3, p0, Landroid/support/constraint/c$a;->l:F
    ...
    :pswitch_1e
    iget v3, p0, Landroid/support/constraint/c$a;->v:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Landroid/support/constraint/c$a;->v:I
    ...
    :pswitch_24
    iget v3, p0, Landroid/support/constraint/c$a;->u:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Landroid/support/constraint/c$a;->u:I
    ...
    sget-object v2, Landroid/support/constraint/c;->V:[I
    ...
    :pswitch_2c
    iget v3, p0, Landroid/support/constraint/c$a;->k:F
    ...
    :pswitch_2d
    iget v3, p0, Landroid/support/constraint/c$a;->S:F
    ...
    :pswitch_3e
    iget v3, p0, Landroid/support/constraint/c$a;->w:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Landroid/support/constraint/c$a;->w:I
...
.method private static Code(Landroid/view/View;Ljava/lang/String;)[I
    .locals 9
    ...
    invoke-virtual {v7, v5}, Landroid/support/constraint/ConstraintLayout;->Code(Ljava/lang/Object;)Ljava/lang/Object;
...
# virtual methods
.method final Code(Landroid/support/constraint/ConstraintLayout;)V
    .locals 9
    ...
    iget-object v2, p0, Landroid/support/constraint/c;->Code:Ljava/util/HashMap;
    ...
    iget-object v7, p0, Landroid/support/constraint/c;->Code:Ljava/util/HashMap;
    ...
    iput v4, v7, Landroid/support/constraint/c$a;->as:I
    ...
    iget v3, v7, Landroid/support/constraint/c$a;->as:I
    ...
    iget-boolean v4, v7, Landroid/support/constraint/c$a;->aq:Z
    ...
    :cond_2
    iget-object v4, v7, Landroid/support/constraint/c$a;->au:Ljava/lang/String;

    if-eqz v4, :cond_3

    iget-object v4, v7, Landroid/support/constraint/c$a;->au:Ljava/lang/String;

    invoke-static {v3, v4}, Landroid/support/constraint/c;->Code(Landroid/view/View;Ljava/lang/String;)[I
    ...
    invoke-virtual {v7, v3}, Landroid/support/constraint/c$a;->Code(Landroid/support/constraint/ConstraintLayout$a;)V

    invoke-virtual {v5, v3}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget v3, v7, Landroid/support/constraint/c$a;->z:I
    ...
    iget v3, v7, Landroid/support/constraint/c$a;->Q:F
    ...
    iget-boolean v3, v7, Landroid/support/constraint/c$a;->R:Z

    if-eqz v3, :cond_6

    iget v3, v7, Landroid/support/constraint/c$a;->T:F
    ...
    :cond_b
    iget-object v6, v2, Landroid/support/constraint/c$a;->au:Ljava/lang/String;

    if-eqz v6, :cond_c

    iget-object v6, v2, Landroid/support/constraint/c$a;->au:Ljava/lang/String;

    invoke-static {v5, v6}, Landroid/support/constraint/c;->Code(Landroid/view/View;Ljava/lang/String;)[I

    move-result-object v6

    iput-object v6, v2, Landroid/support/constraint/c$a;->at:[I
    ...
    invoke-static {}, Landroid/support/constraint/ConstraintLayout;->Code()Landroid/support/constraint/ConstraintLayout$a;

    move-result-object v6

    invoke-virtual {v5}, Landroid/support/constraint/a;->Code()V

    invoke-virtual {v2, v6}, Landroid/support/constraint/c$a;->Code(Landroid/support/constraint/ConstraintLayout$a;)V
    ...
    :cond_d
    :goto_6
    iget-boolean v5, v2, Landroid/support/constraint/c$a;->Code:Z
    ...
    invoke-virtual {v2, v1}, Landroid/support/constraint/c$a;->Code(Landroid/support/constraint/ConstraintLayout$a;)V
